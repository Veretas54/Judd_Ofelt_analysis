...
Набор классов и инструментов, позволяющий выполнять полный цикл расчёта параметров Джадда-Офельта и радиационных характеристик ионов.
...
- Автоматическое и ручное определение границ полос
...
Используется при сильном перекрытии двух разных термов.
...
Применяется когда несколько термов образуют одну неразрешённую полосу.
<img src="images/grouped_example.png" alt="Рисунок 4. Пример использования Grouped">
Paired подразумевает, что вклады термов можно условно разделить, в отличие от Grouped.
